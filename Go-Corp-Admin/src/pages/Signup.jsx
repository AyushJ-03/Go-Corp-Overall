...
import { Mail, Lock, User, Chrome, Shield, Globe, Landmark, Building2, Trees } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white font-sans flex text-gray-900">
      ...
      <div className="w-full lg:w-[55%] p-8 md:p-16 flex flex-col justify-between">
        ...
        <div className="max-w-[420px] w-full mx-auto my-12">
          ...
          <p className="text-gray-500 mb-8 font-medium">Get started with your free GoCorp account today.</p>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-start gap-2 py-1">
              ...
              <label htmlFor="terms" className="text-sm font-medium text-gray-600">
                I agree to GoCorp's <a href="#" className="text-blue-600 hover:underline">Terms of Service</a> and <a href="#" className="text-blue-600 hover:underline">Privacy Policy</a>
              </label>
            </div>
